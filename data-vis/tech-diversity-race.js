function TechDiversityRace() {
  ...
  this.setup = function() {
    ...
    // ???	  
	  //declare datacolumn length
	  var dataColumnLength = this.data.getColumnCount();
	  //set var company names to push array into for loading
	  var companyNames = {};
	  //add options to select box
	  for (var i = 1; i < dataColumnLength ; i ++){
